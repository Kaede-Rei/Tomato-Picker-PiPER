...
QtObject {
    ...
    readonly property string font_stack: "Maple Mono Normal NF CN, San Francisco, SF Pro Text, PingFang SC, Helvetica Neue, Arial, sans-serif"

    readonly property string mono_font_stack: "JetBrains Mono, Maple Mono Normal NF CN, SF Mono, Menlo, Consolas, monospace"
}
